...
describe 'puppet::server::puppetserver' do
  on_supported_os.each do |os, facts|
    ...
    describe 'with default parameters' do
      ...
      it { should contain_augeas('puppet::server::puppetserver::jvm_args').
              with_changes('set JAVA_ARGS \'"-Xms2G -Xmx2G"\'').
              with_context('/files/etc/default/puppetserver').
              with_incl('/etc/default/puppetserver').
              with_lens('Shellvars.lns').
              with({})
      }
      it { should contain_augeas('puppet::server::puppetserver::java_bin').
              with_changes('set JAVA_BIN /usr/bin/java').
              with_context('/files/etc/default/puppetserver').
              with_incl('/etc/default/puppetserver').
              with_lens('Shellvars.lns').
              with({})
    ...
    describe 'with extra_args parameter' do
      ...
      it { should contain_augeas('puppet::server::puppetserver::jvm_args').
              with_changes('set JAVA_ARGS \'"-Xms2G -Xmx2G -XX:foo=bar -XX:bar=foo"\'').
              with_context('/files/etc/default/puppetserver').
              with_incl('/etc/default/puppetserver').
              with_lens('Shellvars.lns').
              with({})
